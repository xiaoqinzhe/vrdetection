...
ww_add_file_name = '../dataset2/edges_ww_add.txt'
...
remove_words_l.sort()
with open('../dataset2/vocab_remove.txt', 'w') as file:
    for word in remove_words_l:
        file.write('{}\n'.format(word))

num_edges = 0

with open(ww_add_file_name) as ifile, open('../dataset2/edges_ww_final.txt', 'w') as ofile:
    for line in ifile:
        w1, w2, cnt = line.strip().split()
