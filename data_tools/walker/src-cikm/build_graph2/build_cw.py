...
vocab_file_name = '../dataset2/vocab.txt'
venues_file_name = '../dataset2/venues.txt'
paper_venue_file_name = '../dataset2/paper_title_venue.txt'
...
with open('../dataset2/edges_cw.txt', 'w') as file:
